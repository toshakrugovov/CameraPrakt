...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button cameraOpen = (Button) findViewById(R.id.camera_button);
        ...
        cameraOpen.setOnClickListener(y -> startActivityForResult(new Intent(MediaStore.ACTION_IMAGE_CAPTURE), PHOTO_ID));
    ...
    private void loadImagesFromCash(){ //Подгружает фотографии
